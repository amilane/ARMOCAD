...
namespace MTO
{
    ...
    public class MTOClass : IExternalCommand
    {
            ...
            ElementSet elements)
        {
            ...
            try
            {
                ...
                //engine.ExecuteFile(@"C:\Drive\ARMOPlug\ARMOCAD\ARMOCAD\Resources\MTO.py", scope);

                string DetailLinesLength = Assembly.GetExecutingAssembly().GetName().Name + ".Resources." + "MTO.py";
