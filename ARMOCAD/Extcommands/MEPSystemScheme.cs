...
namespace MEPSystemScheme
{
    [Transaction(TransactionMode.Manual)]
    public class MEPSystemSchemeClass : IExternalCommand
    {
            ...
            ElementSet elements)
        {
            ...
            try
            {
                ...
                //engine.ExecuteFile(@"C:\Drive\ARMOPlug\ARMOCAD\ARMOCAD\Resources\MEPSystemScheme.py", scope);

                string DetailLinesLength = Assembly.GetExecutingAssembly().GetName().Name + ".Resources." + "MEPSystemScheme.py";
