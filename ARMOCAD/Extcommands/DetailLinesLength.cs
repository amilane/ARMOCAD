...
namespace DetailLinesLength
{
	[Transaction(TransactionMode.Manual)]
	public class DetailLinesLengthClass : IExternalCommand
	{
			...
			ElementSet elements)
		{
			...
			try
			{
				...
				string DetailLinesLength = Assembly.GetExecutingAssembly().GetName().Name + ".Resources." + "DetailLinesLength.py";
