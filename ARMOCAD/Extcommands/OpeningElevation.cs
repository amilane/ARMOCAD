...
namespace OpeningElevation
{
	[Transaction(TransactionMode.Manual)]
	public class OpeningElevationClass : IExternalCommand
	{
			...
			ElementSet elements)
		{
			...
			try
			{
				...
				string DetailLinesLength = Assembly.GetExecutingAssembly().GetName().Name + ".Resources." + "OpeningElevation.py";
