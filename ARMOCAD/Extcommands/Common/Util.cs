...
namespace ARMOCAD
{
  public static class Util
  {
    ...
    /// LINQ post-processing.
    /// </summary>
    public static FamilySymbol GetFamilySymbolByName(
      Document doc,
      string name)
    {
      return new FilteredElementCollector(doc)
    ...
    /// </summary>
    /// <returns></returns>
    public static IList<Element> GetElementsByStringParameter(
      Document doc,
      BuiltInParameter bip,
      string value)
    {
      ParameterValueProvider fvp = new ParameterValueProvider(new ElementId(bip));
      FilterStringRuleEvaluator fsre = new FilterStringEquals();
      FilterRule rule = new FilterStringRule(fvp, fsre, value, true);
