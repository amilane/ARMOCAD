...
namespace ThiDuct
{
    ...
    public class ThiDuctClass : IExternalCommand
    {
            ...
            ElementSet elements)
        {
            ...
            try
            {
                ...
                //engine.ExecuteFile(@"C:\Drive\ARMOPlug\ARMOCAD\ARMOCAD\Resources\ThiDuct.py", scope);

                string DetailLinesLength = Assembly.GetExecutingAssembly().GetName().Name + ".Resources." + "ThiDuct.py";
